    ...
    >
      ...
      <div className="flex flex-col items-center gap-5 mt-8 md:flex-row">
        ...
        <div className="flex flex-col gap-3 md:w-2/3">
          ...
          <p className="text-gray-400">
            Release Date: {info.detail.first_air_date.split("-")[0]}
          </p>
          <p className="text-lg">
            User Score:{" "}
      ...
      <div className="mt-10">
        ...
        {info.watchproviders && info.watchproviders.rent && (
          <>
            <h3 className="text-xl text-gray-500 mb-2 mt-4">
              Available for Rent
            </h3>
            <div className="flex gap-3">
      ...
      {/* Part 5: Recommendations and Similar tvs */}
      <div className="mt-10">
      <h1 className="text-zinc-500" >recommandations</h1>
